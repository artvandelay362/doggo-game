...
function Frame21({ onClick }: Frame21Props) {
  return (
    ...
    >
      <p className="font-['Pixelify_Sans'] font-normal leading-[normal] relative shrink-0 text-[#0f111c] text-[40px] text-center text-nowrap whitespace-pre">
        Start Game
      </p>
  ...
  return (
    <div className="h-full w-[1236px] mx-auto bg-gradient-to-b from-[rgba(16,18,28,0.4)] to-[#10121c] overflow-clip flex flex-col items-center">
      ...
      <div className="mt-[20px] min-[1400px]:mt-[45px] mb-0 min-[1024px]:mb-[-16px] flex flex-col items-center gap-[8px]">
        ...
        <p className="mb-[-24px] font-['Pixelify_Sans'] font-normal leading-[normal] text-[20px] min-[1400px]:text-[24px] text-[rgba(255,255,255,0.7)] text-center whitespace-pre">
      ...
      {/* Hey, Comrade! heading */}
      <h1
        className="mt-[50px] min-[1400px]:mt-[78px] font-['Pixelify_Sans'] text-yellow-400 text-center"
      ...
      <div className="mt-[24px] font-['Pixelify_Sans'] font-normal leading-[normal] text-[34px] min-[1400px]:text-[40px] text-[rgba(255,255,255,0.7)] text-center w-[1136px]">
      ...
      {/* Disclaimer text */}
      <p className="mt-[40px] min-[1400px]:mt-[60px] font-['Pixelify_Sans'] font-normal leading-[normal] text-[20px] min-[1400px]:text-[24px] text-[rgba(255,255,255,0.7)] text-center w-[1146px] whitespace-pre-wrap">
